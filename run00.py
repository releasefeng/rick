...
class MyWindow(QtGui.QMainWindow):
    ...
    def createActions(self):
        self.zoominAction=QtGui.QAction(QtGui.QIcon("icons/zoomin.png"),self.trUtf8("放大"),self)
    ...
    def createMenus(self):
        newMenu=self.ui.fileMenu.addMenu('play')#二级菜单
        newMenu.addAction(self.zoominAction)#二级菜单添加Action
        self.ui.fileMenu.addAction(self.zoominAction)
